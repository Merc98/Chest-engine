...
begin
  shellexecute(0,'open',pchar('https://www.voiceservice.io/support'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://www.voiceservice.io/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;

procedure TAbout.Label9Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://www.voiceservice.io/forum'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
