...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfAppToMakeUseOfThisFeature = 'Please run the 64-bit version of '+strCheatEngine+' to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfAppToMakeUseOfThisFeature);
  {$endif}
