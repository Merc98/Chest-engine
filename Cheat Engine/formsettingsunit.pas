...
resourcestring
  ...
  rsPopupHideApp = 'Popup/Hide '+strCheatEngine;
...
begin
  ...
  begin
    n:=f[i];
    if not (fileexists(n+pathsep+'voiceservice.po') or fileexists(n+PathDelim+'voiceservice-x86_64.po') or fileexists(n+PathDelim+'voiceservice-i386.po')) then
      continue;
