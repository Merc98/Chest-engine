...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantAppToTryAndFillInTheMostBasicType = 'Do you want VoiceService '
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantAppToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
