...
resourcestring
  ...
  rsThisWillAttachTheDebuggerToTheCurrent = 'This will attach the debugger of '+strCheatEngine+' to the current process.';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerToTheCurrent+' '+rsContinue;
