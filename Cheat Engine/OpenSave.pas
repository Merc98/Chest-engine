...
resourcestring
  ...
  rsOSThereIsANewerVersionOutEtc = 'There is a newer version of '+strCheatEngine+' out. It''s recommended to use that version instead';
      ...
      begin
        try
          ...
          if (version>CurrentTableVersion) then
            showmessage(rsOSThereIsANewerVersionOutEtc);
