...
begin
  ...
  c:=penv^.FindClass(penv, 'org/voiceservice/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/voiceservice/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/voiceservice/TMemScan');
