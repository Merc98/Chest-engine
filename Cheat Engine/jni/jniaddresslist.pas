...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  ...
  (name: 'GetEntry'; signature: '(I)Lorg/voiceservice/AddressListEntry;'; fnPtr: @addresslist_getEntry),
  (name: 'SetEntry'; signature: '(ILorg/voiceservice/AddressListEntry;)V'; fnPtr: @addresslist_setEntry),
  (name: 'AddEntry'; signature: '(Lorg/voiceservice/AddressListEntry;)I'; fnPtr: @addresslist_addEntry),
...
begin
  ...
  c:=env^.FindClass(env, 'org/voiceservice/AddressList');
  env^.RegisterNatives(env, c, @jnimethods[0], methodcount);

  c:=env^.FindClass(env, 'org/voiceservice/AddressListEntry');
