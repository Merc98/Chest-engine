...
resourcestring
  ...
  rsAppIsBeingAFag = 'App is being a fag';
        ...
        begin
          case parameters[i].VType of
            ...
            system.vtWideChar, vtPWideChar, vtVariant, vtInterface,
              vtWideString: lua_pushstring(L, rsAppIsBeingAFag);
...
function supportApp(L: Plua_State): integer; cdecl;
var
  parameters: integer;
...
function fuckApp(L: Plua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(L));
  if adwindow<>nil then
...
function lua_getAppProcessID(L: PLua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(l));
...
function appIs64Bit(L: PLua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(L));
...
function lua_getAppFileVersion(L: Plua_State): integer; cdecl;
begin
...
begin
  ...
  lua_register(L, 'appIs64Bit', appIs64Bit);
...
begin
  ...
  begin
    ...
    Lua_register(L, 'supportApp', supportApp);
    Lua_register(L, 'fuckApp', fuckApp);
    ...
    lua_register(L, 'getAppProcessID', lua_getAppProcessID);
    ...
    lua_register(L, 'getAppFileVersion', lua_getAppFileVersion);
